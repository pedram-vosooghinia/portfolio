...
const RecentProjects = () => {
  ...
  const translations = {
    en: {
      ...
      liveSiteText: "Check Live Site",
    },
    fa: {
      heading: "مروری بر",
      liveSiteText: "مشاهده سایت",
    },
  };

  const { heading, liveSiteText } = translations[language] || translations.en;

  return (
    <div id="projects" className="w-full">
      <h1 className="heading py-20">
        {heading} <span className="text-green-500">{language === "fa" ? "پروژه‌های اخیر" : "recent projects"}</span>
      </h1>
        ...
        {projects.map((item) => (
          ...
          >
            ...
            <p className="lg:text-xl lg:font-normal font-light text-sm line-clamp-2">
              {language === "fa" ? item.desFa : item.des}
            </p>

            <div className="ltr flex items-center justify-between mt-7">
