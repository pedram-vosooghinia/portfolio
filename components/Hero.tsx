...
const Hero = () => {
  return (
    <div className="pb-20 pt-36 ">
      ...
      <div
        className="h-screen w-full dark:bg-black-100 bg-yellow-400 dark:bg-grid-white/[0.2] bg-grid-black-100/[0.08]
      ...
      <div className="flex justify-center relative mt-52 z-10">
